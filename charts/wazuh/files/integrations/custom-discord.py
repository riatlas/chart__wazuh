...
#      <hook_url>https://XXXXXXXXXXXXXX</hook_url>
...
def generate_msg(alert: any, options: any) -> any:
    ...
    if alert.get('data',{}).get('win',{}).get('eventdata',{}).get('threat ID',{}):
        fields.append(
            {
                "name": "Detected threat",
                "value": "{}".format(alert['data']['win']['eventdata']['threat Name']),
                "inline": True
            },
            {
                "name": "Reference",
                "value": "{}".format(alert['data']['win']['eventdata']['fWLink']),
                "inline": True
            }
        )
    ...
    msg['embeds'].append(
        {
            "title": "{}".format(alert['rule']['description'] if 'description' in alert['rule'] else 'N/A'),
            "color": "{}".format(color),
